...
class KDTreeFlann:
    ...
    def __init__(self, feature: open3d.cuda.pybind.pipelines.registration.Feature) -> None:
        ...
    def search_hybrid_vector_3d(self, query: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], radius: float, max_nn: int) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
        ...
        """
    def search_hybrid_vector_xd(self, query: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]], radius: float, max_nn: int) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
        ...
        Returns:
            tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]
        """
    def search_knn_vector_3d(self, query: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], knn: int) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[3, 1]]): The input query point.
        ...
        Returns:
            tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]
        """
    def search_knn_vector_xd(self, query: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]], knn: int) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[m, 1]]): The input query point.
            knn (int): ``knn`` neighbors will be searched.
        ...
        Returns:
            tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]
        """
    def search_radius_vector_3d(self, query: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], radius: float) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[3, 1]]): The input query point.
            radius (float): Search radius.
        ...
        Returns:
            tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]
        """
    def search_radius_vector_xd(self, query: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]], radius: float) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[m, 1]]): The input query point.
            radius (float): Search radius.
        ...
        Returns:
            tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]
        """
    def search_vector_3d(self, query: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]], search_param: KDTreeSearchParam) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[3, 1]]): The input query point.
        ...
        Returns:
            tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]
        """
    def search_vector_xd(self, query: numpy.ndarray[tuple[M, typing.Literal[1]], numpy.dtype[numpy.float64]], search_param: KDTreeSearchParam) -> tuple[int, open3d.cuda.pybind.utility.IntVector, open3d.cuda.pybind.utility.DoubleVector]:
        """
        Args:
            query (numpy.ndarray[numpy.float64[m, 1]]): The input query point.
            search_param (open3d.cuda.pybind.geometry.KDTreeSearchParam)
...
class LineSet(Geometry3D):
    ...
    @staticmethod
    @typing.overload
    def create_camera_visualization(intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic, extrinsic: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]], scale: float = 1.0) -> LineSet:
        """
        Factory function to create a LineSet from intrinsic and extrinsic camera matrices
        """
    @staticmethod
...
class PointCloud(Geometry3D):
    ...
    """
    @staticmethod
    def create_from_depth_image(depth: Image, intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic, extrinsic: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]] = ..., depth_scale: float = 1000.0, depth_trunc: float = 1000.0, stride: int = 1, project_valid_depth_only: bool = True) -> PointCloud:
        """
        ...
        """
    @staticmethod
    def create_from_rgbd_image(image: RGBDImage, intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic, extrinsic: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]] = ..., project_valid_depth_only: bool = True) -> PointCloud:
        """
...
class VoxelGrid(Geometry3D):
    ...
    def get_voxel(self, point: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.int32]]:
        ...
        """
    def get_voxel_bounding_points(self, index: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.int32]]) -> open3d.cuda.pybind.utility.Vector3dVector:
        """
