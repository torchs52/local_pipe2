...
class CorrespondenceChecker:
    ...
    """
    def Check(self, source: open3d.cuda.pybind.geometry.PointCloud, target: open3d.cuda.pybind.geometry.PointCloud, corres: open3d.cuda.pybind.utility.Vector2iVector, transformation: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]]) -> bool:
        """
...
class TransformationEstimation:
    ...
    def compute_rmse(self, source: open3d.cuda.pybind.geometry.PointCloud, target: open3d.cuda.pybind.geometry.PointCloud, corres: open3d.cuda.pybind.utility.Vector2iVector) -> float:
        ...
        Returns:
            float
        """
    def compute_transformation(self, source: open3d.cuda.pybind.geometry.PointCloud, target: open3d.cuda.pybind.geometry.PointCloud, corres: open3d.cuda.pybind.utility.Vector2iVector) -> numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]]:
        """
...
def correspondences_from_features(source_features: Feature, target_features: Feature, mutual_filter: bool = False, mutual_consistency_ratio: float = 0.10000000149011612) -> open3d.cuda.pybind.utility.Vector2iVector:
    ...
    """
def evaluate_registration(source: open3d.cuda.pybind.geometry.PointCloud, target: open3d.cuda.pybind.geometry.PointCloud, max_correspondence_distance: float, transformation: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]] = ...) -> RegistrationResult:
    """
