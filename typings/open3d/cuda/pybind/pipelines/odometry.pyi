...
def compute_correspondence(intrinsic_matrix: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]], extrinsic: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]], depth_s: open3d.cuda.pybind.geometry.Image, depth_t: open3d.cuda.pybind.geometry.Image, option: OdometryOption = ...) -> open3d.cuda.pybind.utility.Vector4iVector:
    ...
    """
def compute_rgbd_odometry(rgbd_source: open3d.cuda.pybind.geometry.RGBDImage, rgbd_target: open3d.cuda.pybind.geometry.RGBDImage, pinhole_camera_intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic = ..., odo_init: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]] = ..., jacobian: RGBDOdometryJacobian = ..., option: OdometryOption = ...) -> tuple[bool, numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]], numpy.ndarray[tuple[typing.Literal[6], typing.Literal[6]], numpy.dtype[numpy.float64]]]:
    """
