...
class TSDFVolume:
    ...
    def extract_triangle_mesh(self) -> open3d.cuda.pybind.geometry.TriangleMesh:
        ...
        """
    def integrate(self, image: open3d.cuda.pybind.geometry.RGBDImage, intrinsic: open3d.cuda.pybind.camera.PinholeCameraIntrinsic, extrinsic: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]]) -> None:
        """
