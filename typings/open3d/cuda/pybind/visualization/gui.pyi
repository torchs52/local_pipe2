...
class SceneWidget(Widget):
    ...
    def set_view_controls(self, arg0: SceneWidget.Controls) -> None:
        ...
        """
    @typing.overload
    def setup_camera(self, arg0: float, arg1: open3d.cuda.pybind.geometry.AxisAlignedBoundingBox, arg2: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float32]]) -> None:
        """
        Configure the camera: setup_camera(field_of_view, model_bounds, center_of_rotation)
        """
    @typing.overload
    def setup_camera(self, arg0: open3d.cuda.pybind.camera.PinholeCameraIntrinsic, arg1: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]], arg2: open3d.cuda.pybind.geometry.AxisAlignedBoundingBox) -> None:
        """
        setup_camera(intrinsics, extrinsic_matrix, model_bounds): sets the camera view
        """
    @typing.overload
    def setup_camera(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[3]], numpy.dtype[numpy.float64]], arg1: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]], arg2: int, arg3: int, arg4: open3d.cuda.pybind.geometry.AxisAlignedBoundingBox) -> None:
        """
