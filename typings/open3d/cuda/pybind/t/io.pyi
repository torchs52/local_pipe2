...
class RealSenseSensor(RGBDSensor):
    ...
    def init_sensor(self, sensor_config: ... = ..., sensor_index: int = 0, filename: str = '') -> bool:
        ...
        Args:
            sensor_config (open3d::io::RGBDSensorConfig, optional, default=<open3d.cuda.pybind.t.io.RealSenseSensorConfig object at 0x76b451bc84f0>): Camera configuration, such as resolution and framerate. A serial number can be entered here to connect to a specific camera.
    ...
    def init_sensor(self, sensor_config: RealSenseSensorConfig = ..., sensor_index: int = 0, filename: str = '') -> bool:
        ...
        Args:
            sensor_config (open3d.cuda.pybind.t.io.RealSenseSensorConfig, optional, default=<open3d.cuda.pybind.t.io.RealSenseSensorConfig object at 0x76b451a12830>): Camera configuration, such as resolution and framerate. A serial number can be entered here to connect to a specific camera.
            sensor_index (int, optional, default=0): Connect to a camera at this position in the enumeration of RealSense cameras that are currently connected. Use enumerate_devices() or list_devices() to obtain a list of connected cameras. This is ignored if sensor_config contains a serial entry.
            filename (str, optional, default=''): Save frames to a bag file
