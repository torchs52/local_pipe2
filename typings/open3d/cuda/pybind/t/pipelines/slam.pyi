...
class Frame:
    ...
    def __init__(self, arg0: Frame) -> None:
        ...
        """
    @typing.overload
    def __init__(self, height: int, width: int, intrinsics: open3d.cuda.pybind.core.Tensor, device: open3d.cuda.pybind.core.Device) -> None:
        """
        Args:
...
class Model:
    ...
    def __init__(self) -> None:
        ...
    def extract_pointcloud(self, weight_threshold: float = 3.0, estimated_number: int = -1) -> open3d.cuda.pybind.t.geometry.PointCloud:
        """
        ...
        """
    def extract_trianglemesh(self, weight_threshold: float = 3.0, estimated_number: int = -1) -> open3d.cuda.pybind.t.geometry.TriangleMesh:
        """
    ...
    def synthesize_model_frame(self, model_frame: Frame, depth_scale: float = 1000.0, depth_min: float = 0.1, depth_max: float = 3.0, trunc_voxel_multiplier: float = 8.0, enable_color: bool = False, weight_threshold: float = -1.0) -> None:
        ...
        Returns:
            None
        """
    def track_frame_to_model(self, input_frame: Frame, model_frame: Frame, depth_scale: float = 1000.0, depth_max: float = 3.0, depth_diff: float = 0.07, method: open3d.cuda.pybind.t.pipelines.odometry.Method = ..., criteria: list[open3d.cuda.pybind.t.pipelines.odometry.OdometryConvergenceCriteria] = ...) -> open3d.cuda.pybind.t.pipelines.odometry.OdometryResult:
        """
