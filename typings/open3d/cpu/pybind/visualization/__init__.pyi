...
class O3DVisualizer(gui.WindowBase):
    ...
    def reset_camera_to_default(self) -> None:
        ...
        """
    def set_background(self, bg_color: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[1]], numpy.dtype[numpy.float32]], bg_image: open3d.cpu.pybind.geometry.Image) -> None:
        """
    ...
    def setup_camera(self, field_of_view: float, center: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float32]], eye: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float32]], up: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float32]]) -> None:
        ...
        """
    @typing.overload
    def setup_camera(self, intrinsic: open3d.cpu.pybind.camera.PinholeCameraIntrinsic, extrinsic_matrix: numpy.ndarray[tuple[typing.Literal[4], typing.Literal[4]], numpy.dtype[numpy.float64]]) -> None:
        """
...
class VisualizerWithVertexSelection(Visualizer):
    ...
    def remove_picked_points(self, indices: open3d.cpu.pybind.utility.IntVector) -> None:
        ...
        """
def draw_geometries(geometry_list: list[open3d.cpu.pybind.geometry.Geometry], window_name: str = 'Open3D', width: int = 1920, height: int = 1080, left: int = 50, top: int = 50, point_show_normal: bool = False, mesh_show_wireframe: bool = False, mesh_show_back_face: bool = False, lookat: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, up: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, front: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]] | None = None, zoom: float | None = None) -> None:
    """
