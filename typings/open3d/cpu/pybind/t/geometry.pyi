...
class TriangleMesh(Geometry, DrawableGeometry):
    ...
    def create_cone(radius: float = 1.0, height: float = 2.0, resolution: int = 20, split: int = 1, float_dtype: open3d.cpu.pybind.core.Dtype = ..., int_dtype: open3d.cpu.pybind.core.Dtype = ..., device: open3d.cpu.pybind.core.Device = ...) -> TriangleMesh:
        ...
        """
    @staticmethod
    def create_coordinate_frame(size: float = 1.0, origin: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]] = ..., float_dtype: open3d.cpu.pybind.core.Dtype = ..., int_dtype: open3d.cpu.pybind.core.Dtype = ..., device: open3d.cpu.pybind.core.Device = ...) -> TriangleMesh:
        """
