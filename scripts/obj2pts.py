...
if __name__ == "__main__":
    ...
    base_dir = "./config/crane3d"
    input_dir = f"{base_dir}/visualize/SCX2000-3/mobile/"
    output_dir = f"{base_dir}/collision_detection/SCX2000-3/mobile_pts/"
